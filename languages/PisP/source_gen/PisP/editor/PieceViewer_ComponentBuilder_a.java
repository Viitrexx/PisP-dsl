...
/*package*/ class PieceViewer_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private JComponent _QueryFunction_JComponent_ujvark_a0() {
    JComponent result;
    switch (enumSwitchIndex.indexNullable(SPropertyOperations.getEnum(myNode, PROPS.lattice$e_Fj))) {
      case 0:
        result = new PieceViewer2DCubic(myNode, getEditorContext());
        break;
      case 1:
        result = new PieceViewer3DCubic(myNode, getEditorContext());
        break;
      case 2:
        result = new PieceViewer3DFCC(myNode, getEditorContext());
        break;
      default:
        result = new JPanel();
        break;
  ...
  private static final EnumerationLiteralsIndex enumSwitchIndex = EnumerationLiteralsIndex.build(0x9ea5405ccd504139L, 0x8b0811b78b688cf5L, 0x2cd4be37af372fL, 0x2cd4be37af3730L, 0x2e8846265a55f50eL, 0x2cd4be37af5e88L);
