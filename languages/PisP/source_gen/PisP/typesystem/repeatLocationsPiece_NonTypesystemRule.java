...
public class repeatLocationsPiece_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public repeatLocationsPiece_NonTypesystemRule() {
  }
  public void applyRule(final SNode piece, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    MultiLinkedList root = new MultiLinkedList<Integer>(null);
    for (SNode location : ListSequence.fromList(SLinkOperations.getChildren(piece, LINKS.locations$ChQi))) {
      ...
      if (!(madeNew)) {
        {
          ...
          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(location, "Duplicate location.", "r:bc41e529-dea7-4ee8-b55b-85ab02ac5dbd(PisP.typesystem)", "7684354715562682600", null, errorTarget);
        }
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.Piece$gT;
  }
